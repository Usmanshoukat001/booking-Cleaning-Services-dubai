...
<head>
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="{{asset('public/admin_asset/assets/vendor/css/pages/page-auth.css')}}" />
...
<body>
    ...
    <div class="position-relative">
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner py-4">
                ...
                <div class="card p-2">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="index.html" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-heading fw-bold">THELMACLEANING</span>
                        </a>
                    </div>
                    <!-- /Logo -->

                    <div class="card-body mt-2">
                        <h4 class="mb-2">Welcome to THELMACLEANING</h4>
                ...
                <!-- /Login -->
                <img alt="mask" src="{{asset('public/admin_asset/assets/img/illustrations/auth-basic-login-mask-light.png')}}" class="authentication-image d-none d-lg-block"
                />
            </div>
        </div>
    </div>
    ...
    <!-- Vendors JS -->
    <script src="{{asset('public/admin_asset/assets/vendor/libs/@form-validation/umd/bundle/popular.min.js')}}"></script>
    <script src="{{asset('public/admin_asset/assets/vendor/libs/@form-validation/umd/plugin-bootstrap5/index.min.js')}}"></script>
    <script src="{{asset('public/admin_asset/assets/vendor/libs/@form-validation/umd/plugin-auto-focus/index.min.js')}}"></script>

    <!-- Main JS -->
    <script src="{{asset('public/admin_asset/assets/js/main.js')}}"></script>

    <!-- Page JS -->
    <script src="{{asset('public/admin_asset/assets/js/pages-auth.js')}}"></script>
</body>
