...
var longDescription = $('#full-editor1').html();
var modelDescription = $('#full-editor2').html();
...
var servicesvgcode = $('textarea[name="servicesvgcode"]').val();
...
if (serviceimage) {
 ...
 const fullEditor = new Quill('#full-editor1', {
   ...
   const fullEditors = new Quill('#full-editor2', {
    bounds: '#full-editor2',
    placeholder: 'Type Something...',
    modules: {
      formula: true,
