...
<div class="col-12">
    <div class="card">
        <h5 class="card-header">About Us Content</h5>
        <div class="card-body">
             <div class="row">
                  <div class="form-floating form-floating-outline mb-4 col-6">
                                    <input class="form-control" name="Title" type="search" value="{{ $about['title'] ?? ''}}" placeholder="Title ..." id="html5-search-input">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <div>
                                         <input class="form-control" name="imagevaluename" value="{{ $about['image'] ?? ''}}" type="hidden" id="formFile">
                                    </div>
                                </div>
                               
                                </div>
            <div id="full-editor12">           </div>
        </div>
...
$(document).ready(function() {
    $('#updateContent').on('click', function() {
        ...
        var about_content = $('#full-editor12').html();
...
const fullEditorss = new Quill('#full-editor12', {
    bounds: '#full-editor12',
...
var modelDescription = {!! json_encode($about['about_content']) !!};

// Set the content of the Quill editor
fullEditorss.clipboard.dangerouslyPasteHTML(modelDescription);
