...
<div class="col-12">
    <div class="card">
        <h5 class="card-header">Privacy Content</h5>
        <div class="card-body">
              <div class="row">
                  <div class="form-floating form-floating-outline mb-4 col-6">
                                    <input class="form-control" name="Title" type="search" value="{{ $privacy['title'] ?? ''}}" placeholder="Title ..." id="html5-search-input">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <div>
                                         <input class="form-control" name="imagevaluename" value="{{ $privacy['image'] ?? ''}}" type="hidden" id="formFile">
                                    </div>
                                </div>
                               
                                </div>
                                
            <div id="full-editor122">
            {!! $privacy['privacy_content'] ?? '<h6>Here you manage content</h6>' !!} 
            </div>
        </div>
...
<script>
    ...
    $('#updateContent').on('click', function() {
        ...
        var privacy_content = $('#full-editor122').html();
        ...
        formData.append('privacy_content', privacy_content);
...
const fullEditorsss = new Quill('#full-editor122', {
    bounds: '#full-editor122',
...
var modelDescription = {!! json_encode($privacy['privacy_content'] ) !!};
