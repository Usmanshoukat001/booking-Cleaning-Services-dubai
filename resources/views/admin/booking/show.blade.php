    ...
    <div class="card mt-5">
      <div class="card">
        ...
        <div class="table-responsive row text-nowrap mx-3 mt-3">
            ...
            <div class="col-6"> <p><b>Building Type:</b> {{$booking->buildingType}}</p></div>
            ...
            <div class="col-6"> <p><b>ADDRESS:</b> {{$booking->ADDRESS}}</p></div>
              <div class="col-6"> <p><b>Total:</b> {{$booking->Total}}</p></div>
            <div class="col-6"> <p><b>paymentgatway:</b> {{$booking->paymentgatway}}</p></div>
              <div class="col-6"> <p><b>status:</b> <span class="badge bg-secondary">{{$booking->status}}</span></p></div>
            <div class="col-12"> <p><b>paymentdetails:</b> {{$booking->paymentdetails}}</p></div>
            <h5>Extra:</h5>
